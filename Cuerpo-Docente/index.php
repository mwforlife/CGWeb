...
<body>
  <div>
   ...
   <main>
      <h2 class="content__title">Equipo Docente - Profesores Líder
          ...
          <div class="container">
            <div class="row">    
                <div class="col-md-3 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="../img/Docentes/EnzoPerez.jpg">
                        </div>
                        <div class="team-content text-center">
                            <h3 class="title">Enzo Barrios Lobos</h3>
                            <span class="post">Profesor</span>
                            <ul class="social">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="../img/Docentes/manuelvillarroel.png">
                        </div>
                        <div class="team-content">
                            <h3 class="title">Manuel Villarroel</h3>
                            <span class="post">PLOC 1 Medio A</span>
                            <ul class="social">
                                <li><a href="#" class="fa-solid fa-envelope"></a></li>
                                <li><a href="#" class="fa-solid fa-phone"></a></li>
                            </ul>
