...
insert into submenu value(null,"Equipo Directivo",2,"Equipo-Directivo",1);
insert into submenu value(null,"Coordinadores Academicos",2,"Coordinadores-academicos",1);
insert into submenu value(null,"Cuerpo Docente PLOC",2,"Cuerpo-Docente",1);
insert into submenu value(null,"Profesores De Asignatura",2,"Profesores-de-Asignaturas",1);
insert into submenu value(null,"Equipo Programa de Integración PIE",2,"PIE",1);
insert into submenu value(null,"Inspectores",2,"Inspectores",1);


insert into submenu value(null,"Reglamento Interno",4,"media/documentos/Reglamentos/REGLAMENTO-INTERNO-2022",1);
