...
<body>
   ...
   <main>
      <h2 class="content__title">Inspectores
        ...
        <div class="col-md-3 col-sm-6">
            <div class="our-team">
                <div class="pic">
                    <img src="../img/Docentes/Bastianreyes.jpeg">
                </div>
                <div class="team-content">
                    <h3 class="title">Bastian Reyes Iturriaga</h3>
                    <span class="post">Inspector Enseñanza Media</span>
                    <ul class="social">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="our-team">
                <div class="pic">
                    <img src="../img/Docentes/mariza.png">
                </div>
                <div class="team-content">
                    <h3 class="title">Mariza del Carmen Rubio Cofré</h3>
                    <span class="post">Inspectora</span>
                    <ul class="social">
                        <li><a href="#" class="fab fa-facebook"></a></li>
                        <li><a href="#" class="fab fa-twitter"></a></li>
                        <li><a href="#" class="fab fa-google-plus"></a></li>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="our-team">
                <div class="pic">
                    <img src="../img/Docentes/img-3.jpg">
                </div>
                <div class="team-content">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="our-team">
                <div class="pic">
                    <img src="../img/Docentes/img-4.jpg">
                </div>
                <div class="team-content">
