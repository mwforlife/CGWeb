...
<body>
   ...
   <main>
      <h2 class="content__title">PROFESORES Lider PLOC
                    ...
                    <div class="row">
                            ...
                            <?php
                                ...
                                for ($i=0; $i < count($lista); $i++) { 
                                    ...
                                    echo "<li><a href='#' class='fab fa-facebook'></a></li>";
                                    echo "<li><a href='#' class='fab fa-twitter'></a></li>";
                                    echo "<li><a href='#' class='fab fa-google-plus'></a></li>";
                                    echo "<li><a href='#' class='fab fa-skype'></a></li>";
                                    echo "</ul>";
                                    echo "</div>";
                                    echo "</div>";
                                    echo "</div>";
